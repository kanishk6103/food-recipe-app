...
const HomeCard = ({ name, image }: { name: string; image: string }) => {
  return (
    <div className="relative flex flex-col justify-center">
      ...
      />
      <div className="w-40 h-44 flex items-center justify-center bg-placeholder-colour bg-opacity-80 rounded-lg">
      ...
      <div className="absolute bottom-0 py-3 px-3 flex justify-between items-end w-full">
        <div className="flex flex-col gap-1 justify-start">
          <div className="font-normal text-xs text-sub-heading">Time</div>
